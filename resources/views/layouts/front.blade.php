...
<head>
  ...
  <link href="{{ base_url('front/') }}css/mdb.min.css" rel="stylesheet">
  <!-- Your custom styles (optional) -->
  <link href="{{ base_url('front/') }}css/style.min.css" rel="stylesheet">
  <style type="text/css">
    html,
    body,
    header,
...
<main>
  ...
  <!-- SCRIPTS -->
  <!-- JQuery -->
  <script type="text/javascript" src="{{ base_url('front/') }}js/jquery-3.4.1.min.js"></script>
  <!-- Bootstrap tooltips -->
  <script type="text/javascript" src="{{ base_url('front/') }}js/popper.min.js"></script>
  <!-- Bootstrap core JavaScript -->
  <script type="text/javascript" src="{{ base_url('front/') }}js/bootstrap.min.js"></script>
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="{{ base_url('front/') }}js/mdb.min.js"></script>
  <!-- Initializations -->
